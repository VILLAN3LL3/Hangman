...
{
    [TestFixture]
    public class HangmanGameWithoutExtensionTests
    {
        private HangmanGameWithoutExtension _hangmanGame;

        [OneTimeSetUp]
        public void SetUp() => _hangmanGame = CreateHangmanGame();

        private HangmanGameWithoutExtension CreateHangmanGame() => new HangmanGameWithoutExtension("Developer");
